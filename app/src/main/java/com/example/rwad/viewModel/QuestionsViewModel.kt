...
class QuestionsViewModel : ViewModel() {
    val questions: List<Question> = listOf(
        Question(
            ...
            "Base class for Adapter", listOf(
                "RecyclerView.Adapter", "ListView.Adapter", "Both of the above", "None of the above"
    ...
    fun nextQuestion(correctAnswer: String , navigateToSuccess: ()-> Unit , navigateToFailure: () -> Unit ) {
